...
import { Zap, Menu, X, Filter, List, Map, Route } from 'lucide-react';
    ...
    <AppProvider>
      <div className="min-h-screen bg-gray-50 flex flex-col">
        ...
        <div className="flex-1 flex flex-col md:flex-row relative">
          ...
          <div className={`
            ${isMobile ? 'flex-1 flex flex-col' : 'w-1/3 min-w-96 max-w-md bg-white border-r border-gray-200 flex flex-col'}
          `}>
            ...
            {/* Filters Panel */}
            {showFilters && (
              <div className={`${isMobile ? 'flex-1' : 'border-b border-gray-200'}`}>
