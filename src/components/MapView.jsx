            ...
            <Popup maxWidth={320} closeButton={false}>
              <div className="p-1">
                ...
                <div className="flex items-start justify-between mb-3">
                  ...
                  >
                    <Star className={`w-4 h-4 ${favorites.includes(station.id) ? 'fill-current' : ''}`} />
                  </button>
                </div>
                ...
                <div className="space-y-2 text-xs">
                  <div className="flex items-center space-x-2">
                    ...
                    <span>{station.connectorType} • {station.power}</span>
                  </div>
                  
                  <div className="flex items-center space-x-2">
                    <Battery className="w-3 h-3 text-electric-600" />
                    <span>{station.availableConnectors}/{station.totalConnectors} konnektör müsait</span>
                  </div>
