  ...
  return (
    <div className="flex flex-col h-full bg-white">
      ...
      <div className="border-b border-gray-200 p-4">
        <h2 className="text-lg font-semibold text-gray-900 mb-2">Rota Planlayıcı</h2>
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                onChange={(e) => handleInputChange('vehicleRange', parseInt(e.target.value))}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-1 focus:ring-primary-500 focus:border-primary-500"
              />
            </div>
            <div>
              ...
              <input
                ...
                onChange={(e) => handleInputChange('currentBattery', parseInt(e.target.value))}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-1 focus:ring-primary-500 focus:border-primary-500"
              />
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center space-x-3">
              <input
                ...
                onChange={(e) => handleInputChange('fastChargingOnly', e.target.checked)}
            ...
            <div className="flex items-center space-x-3">
              <input
                ...
                onChange={(e) => handleInputChange('avoidTolls', e.target.checked)}
                className="w-4 h-4 text-primary-600 border-gray-300 rounded focus:ring-primary-500"
              />
        ...
        {plannedRoute && (
          <div className="space-y-4">
            <div className="border-t border-gray-200 pt-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Planlanan Rota</h3>
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        <div className="font-medium text-gray-900">{route.cost}</div>
              ...
              {/* Charging Stops */}
              <div className="space-y-3">
                <h4 className="font-medium text-gray-900">Önerilen Şarj Durakları</h4>
                
                {plannedRoute.recommendedStations.map((stop, index) => (
                  <div key={index} className="border border-gray-200 rounded-lg p-4">
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex-1">
                        <h5 className="font-medium text-gray-900">{stop.station.name}</h5>
                        <p className="text-sm text-gray-600">{stop.station.operator}</p>
                    ...
                    <div className="bg-gray-50 rounded-lg p-3">
                      <div className="flex items-center justify-between mb-2">
                        <span className="text-sm text-gray-600">Batarya Durumu</span>
                        <span className="text-sm text-gray-600">{stop.distance} km'de</span>
                      </div>
                      <div className="flex items-center space-x-4">
                        <div className="flex-1">
                          <div className="flex items-center justify-between text-sm mb-1">
                            <span className="text-gray-600">Varışta</span>
                            <span className={`font-medium ${getBatteryColor(stop.batteryBefore)}`}>
                              %{stop.batteryBefore}
                            </span>
                          </div>
                          <div className="w-full bg-gray-200 rounded-full h-2">
                            <div
                              className={`h-2 rounded-full ${
                                stop.batteryBefore > 50 ? 'bg-electric-500' :
                                stop.batteryBefore > 20 ? 'bg-yellow-500' : 'bg-red-500'
                              }`}
                        ...
                        <div className="flex-1">
                          <div className="flex items-center justify-between text-sm mb-1">
                            ...
                            <span className={`font-medium ${getBatteryColor(stop.batteryAfter)}`}>
                              %{stop.batteryAfter}
                            </span>
                          </div>
                          <div className="w-full bg-gray-200 rounded-full h-2">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          ...
          <ul className="text-sm text-blue-800 space-y-1">
            <li>• Seyahat öncesi aracınızın %80-100 şarjlı olmasını sağlayın</li>
            <li>• Yoğun saatlerde şarj istasyonlarında bekleme olabileceğini unutmayın</li>
